...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(321, 303)
        MainWindow.setMinimumSize(QtCore.QSize(321, 303))
        MainWindow.setMaximumSize(QtCore.QSize(321, 303))
        icon = QtGui.QIcon()
        ...
        self.operationsTabWidget.setGeometry(QtCore.QRect(20, 140, 281, 121))
        ...
        self.extractButton_2 = QtWidgets.QPushButton(self.tab_6)
        self.extractButton_2.setGeometry(QtCore.QRect(95, 60, 80, 23))
        self.extractButton_2.setObjectName("extractButton_2")
        ...
        self.pdfListWidget = QtWidgets.QListWidget(self.centralwidget)
        self.pdfListWidget.setGeometry(QtCore.QRect(20, 10, 281, 65))
        self.pdfListWidget.setFocusPolicy(QtCore.Qt.NoFocus)
        self.pdfListWidget.setAlternatingRowColors(True)
        self.pdfListWidget.setSelectionMode(QtWidgets.QAbstractItemView.MultiSelection)
        self.pdfListWidget.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectItems)
        self.pdfListWidget.setObjectName("pdfListWidget")
        self.addButton = QtWidgets.QPushButton(self.centralwidget)
        self.addButton.setGeometry(QtCore.QRect(220, 90, 81, 23))
        self.addButton.setObjectName("addButton")
        self.deleteButton = QtWidgets.QPushButton(self.centralwidget)
        self.deleteButton.setGeometry(QtCore.QRect(130, 90, 81, 23))
        self.deleteButton.setObjectName("deleteButton")
        self.line = QtWidgets.QFrame(self.centralwidget)
        self.line.setGeometry(QtCore.QRect(40, 120, 241, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.extractButton_2.setText(_translate("MainWindow", "Extract"))

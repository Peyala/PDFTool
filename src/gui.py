...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        item_0 = QtWidgets.QTreeWidgetItem(self.pdfTreeWidget)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("resources/frames\\../img/pdf_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pdfTreeWidget.setSortingEnabled(False)
        self.pdfTreeWidget.topLevelItem(0).setText(0, _translate("MainWindow", "1"))
        self.pdfTreeWidget.topLevelItem(0).setText(1, _translate("MainWindow", "21.pdf"))
        self.pdfTreeWidget.topLevelItem(1).setText(0, _translate("MainWindow", "2"))
        self.pdfTreeWidget.topLevelItem(1).setText(1, _translate("MainWindow", "plan.pdf"))
        self.pdfTreeWidget.topLevelItem(2).setText(0, _translate("MainWindow", "3"))
        self.pdfTreeWidget.topLevelItem(2).setText(1, _translate("MainWindow", "soda.pdf"))
